...
function Home() {
    ...
    return (
        ...
        <Fragment>
            ...
            <div id="team" className="min-h-screen bg-io dark:bg-darkfirst w-full py-20">
                <div className="text-center">
                    <button data-aos="fade-top" data-aos-duration="1800" className="text-text dark:text-white px-5 py-3 border-6 border-text uppercase text-xl md:text-3xl font-bold">
                        Skills
                    </button >
                    <p className="mt-5 text-lg md:text-xl font-medium">
